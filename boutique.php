                                        ...
                                        <article class="filter-group">
                                            ...
                                            <div class="filter-content collapse show" id="collapse_3">
                                                <div class="card-body">
                                                    ...
                                                    <button
                                                        class="btn btn-primary btn pink mx-auto d-flex accordbouton">Appliquer</button>
                                                </div><!-- card-body.// -->
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 my-3">
                                <div>
                                    ...
                                    <a href ="panier.php"><button type="button" class="btn btn-primary btn pink mx-auto d-flex">Ajouter au
                                        panier</button></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 my-3">
                                <div>
                                    ...
                                    <h6 class="text-center fw-bold my-3">Adult Dinde 3kg</h6>
                                    <p class="text-center">999 999 999€</p>
                                    <a href ="panier.php"><button type="button" class="btn btn-primary btn pink mx-auto d-block">Ajouter au
                                        panier</button></a>
                                </div>
                            </div>
